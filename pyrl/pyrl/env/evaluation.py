...
class Evaluation:
    ...
    def step(self, action):
        ...
        infos = self.env.step(action, to_list=False, with_info=False)
    ...
    def run(self, pi, num=1, work_dir=None, **kwargs):
        ...
        while self.episode_id < num:
            with torch.no_grad():
                ...
                action, self.rnn_states = pi(recent_obs, mode=self.sample_mode, rnn_states=self.rnn_states, rnn_mode="with_states")
