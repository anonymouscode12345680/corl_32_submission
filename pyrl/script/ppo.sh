python tools/run_rl.py configs/mfrl/ppo/maniskill/maniskill_tf_frame_pn_mix_action_late_state.py --gpu-ids 0 --work-dir=./test --cfg-options \
...
'agent_cfg.actor_cfg.optim_cfg.lr=3e-4' 'agent_cfg.critic_cfg.optim_cfg.lr=3e-4' 'agent_cfg.actor_cfg.nn_cfg.visual_nn_cfg.only_decompose_action=False' \
